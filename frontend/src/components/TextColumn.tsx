...
function TextColumn({ text, setText, handleSubmit }: Props) {
  ...
  return (
    <div className="flex flex-col w-[400px] text-white rounded-l-lg border pt-3 bg-stone-700">
      ...
      <div
        className={` h-[700px] w-full bg-stone-800 rounded-bl-lg ${
